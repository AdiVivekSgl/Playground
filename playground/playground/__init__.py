...
# — see production_plan_overrides.py for details.
#
...
try:
    from playground import production_plan_overrides  # noqa: F401
except Exception:
    import logging
    ...
    logging.getLogger(__name__).warning(
        ...
        "Check that production_plan_overrides.py shipped in this build.",
        exc_info=True,
    )
